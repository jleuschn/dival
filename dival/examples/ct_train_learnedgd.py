"""
Train LearnedGDReconstructor on 'lodopab'.
"""
import numpy as np
from dival import get_standard_dataset
from dival.measure import PSNR
from dival.reconstructors.learnedgd_reconstructor import LearnedGDReconstructor
...
LOG_DIR = './logs/lodopab_learnedgd'
SAVE_BEST_LEARNED_PARAMS_PATH = './params/lodopab_learnedgd'
...
if not check_for_params('learnedgd', 'lodopab', include_learned=False):
    download_params('learnedgd', 'lodopab', include_learned=False)
hyper_params_path = get_hyper_params_path('learnedgd', 'lodopab')
...
for i in range(3):
    ...
    ax[0].set_title('LearnedGDReconstructor')
